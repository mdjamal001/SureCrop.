...
import 'package:sure_crop/screens/offerings_page.dart';
import 'create_contract.dart';
import 'farmer_mycontract_page.dart';
                  ...
                  Center(
                    child: Row(
                      ...
                      children: [
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>FarmerMyContractsPage()));
                          },
